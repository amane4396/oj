 ...
 * @update 2024-04-10
 */
public interface UserService extends IService<User>, ServiceWithAssociation<User> {

    /**
     * 数据列表
     *
     * @param wrapper QueryWrapper<User>
     * @param page    Page<User>
     * @return HashMap<?, ?>
     * @throws Exception Exception
     */
    HashMap<?, ?> list(QueryWrapper<User> wrapper, Page<User> page) throws Exception;
     ...
     * @throws Exception Exception
     */
    void create(UserForCreateDto dto) throws Exception;
     ...
     * @throws Exception Exception
     */
    UserForDetailDto detail(String id) throws Exception;
     ...
     * @throws Exception Exception
     */
    void update(UserForUpdateDto dto) throws Exception;
    ...
    //  * @throws Exception Exception
    //  */
    // public void exportData(QueryWrapper<User> wrapper) throws Exception;
