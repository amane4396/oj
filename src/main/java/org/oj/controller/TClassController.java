...
public class TClassController {
    ...
    public JsonRes list(@RequestBody String requestBody) throws Exception {
        ...
        DataListUtil.query(TClass.class, wrapper, query);
        ...
        // 分页
        Page<TClass> page = DataListUtil.getPage(requestBody);

        HashMap<?, ?> results = tClassService.list(wrapper, page);
    ...
    public JsonRes create(@RequestBody String requestBody) throws Exception {
        TClassForCreateDto dto = objectMapper.readValue(requestBody, TClassForCreateDto.class);
        tClassService.create(dto);
    ...
    public JsonRes detail(@PathVariable("id") String id) throws Exception {
        return JsonRes.success(tClassService.detail(id));
    }
    ...
    public JsonRes update(@RequestBody String requestBody) throws Exception {
        TClassForUpdateDto dto = objectMapper.readValue(requestBody, TClassForUpdateDto.class);
        tClassService.update(dto);
    ...
    //  */
    // @PostMapping("/import")
    // @Permission("tClass.import")
    // public JsonRes importData(MultipartRequest multipartRequest) {
    //     tClassService.importData(multipartRequest);
    ...
    //     }
    //
    //    try (Workbook workbook = tClassService.exportData(wrapper); OutputStream os = response.getOutputStream()) {
    //    workbook.write(os);
    //    os.flush();
    //    }
    // }
    ...
    //     return JsonRes.success(tClassService.selectList());
    // }
}
