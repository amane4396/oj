...
public class UserTypeController {
    ...
    public JsonRes list(@RequestBody String requestBody) throws Exception {
        QueryWrapper<UserType> wrapper = new QueryWrapper<>();

        // 查询
        Map<String, JsonNode> query = DataListUtil.getQuery(requestBody);
        DataListUtil.query(UserType.class, wrapper, query);
        ...
        // 分页
        Page<UserType> page = DataListUtil.getPage(requestBody);

        HashMap<?, ?> results = userTypeService.list(wrapper, page);
    ...
    public JsonRes create(@RequestBody String requestBody) throws Exception {
        UserTypeForCreateDto dto = objectMapper.readValue(requestBody, UserTypeForCreateDto.class);
    ...
    public JsonRes detail(@PathVariable("id") String id) throws Exception {
        return JsonRes.success(userTypeService.detail(id));
    }
    ...
    public JsonRes update(@RequestBody String requestBody) throws Exception {
        UserTypeForUpdateDto dto = objectMapper.readValue(requestBody, UserTypeForUpdateDto.class);
    ...
    //  */
    // @PostMapping("/import")
    // @Permission("userType.import")
    // public JsonRes importData(MultipartRequest multipartRequest) {
    //     userTypeService.importData(multipartRequest);
    ...
    //     }
    //
    //    try (Workbook workbook = userTypeService.exportData(wrapper); OutputStream os = response.getOutputStream()) {
    //    workbook.write(os);
    //    os.flush();
    //    }
    // }
    ...
    //     return JsonRes.success(userTypeService.selectList());
    // }
}
